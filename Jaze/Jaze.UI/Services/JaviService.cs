...
namespace Jaze.UI.Services
{
    public class JaviService : ServiceBase<JaviModel>
    {
        ...
        //    {
        //        return db.JaVis.Where(o => o.Word.Contains(key)).ToArray();
        //    }
        //    else
        //    {
        //        return db.JaVis.Where(o => (o.Kana!=null && o.Word.Contains(key)) || o.Kana.Contains(key)).ToArray();
        //    }
        //}
        ...
        //    if (StringUtil.IsContainKanji(key))
        //    {
        //        return db.JaVis.Where(o => o.Word.EndsWith(key)).ToArray();
        //    }
        //    else
        //    {
        //        return db.JaVis.Where(o => (o.Kana != null && o.Word.EndsWith(key)) || o.Kana.EndsWith(key)).ToArray();
        //    }
        ...
        //    if (StringUtil.IsContainKanji(key))
        //    {
        //        return db.JaVis.Where(o => o.Word.StartsWith(key)).ToArray();
        //    }
        //    else
        //    {
        //        return db.JaVis.Where(o => (o.Kana != null && o.Word.StartsWith(key)) || o.Kana.StartsWith(key)).ToArray();
        //    }
        ...
        //    if (StringUtil.IsContainKanji(key))
        //    {
        //        return db.JaVis.Where(o => o.Word == key).ToArray();
        //    }
        //    else
        //    {
        //        return db.JaVis.Where(o => o.Word == key || o.Kana == key).ToArray();
        //    }
